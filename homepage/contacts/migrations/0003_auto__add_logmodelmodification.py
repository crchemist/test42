...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogModelModification'
        db.create_table(u'contacts_logmodelmodification', (
        ...
        db.send_create_signal(u'contacts', ['LogModelModification'])


    def backwards(self, orm):
        # Deleting model 'LogModelModification'
        db.delete_table(u'contacts_logmodelmodification')
    ...
    models = {
        ...
        u'contacts.logmodelmodification': {
            'Meta': {'ordering': "('-action_time',)", 'object_name': 'LogModelModification'},
